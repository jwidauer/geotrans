...
class Egm2008GeoidGrid {
 protected:
  ...
  //                     least _nGridPad = int( O / 2 ) rows/cols of pad on each
  //                     edge.
 ...
 public:
   ...
   *    latitude           : Geodetic latitude                 ( input  -
   * radians ) longitude          : Geodetic longitude                ( input  -
   * radians ) gHeight            : Geoid height                      ( output -
   * meters  )
   *
 ...
 protected:
   ...
   *    latitude           : Geodetic latitude                 ( output -
   * radians ) longitude          : Geodetic longitude                ( output -
   * radians )
   *
   *    return value       : The function's error flag;
   *                         errors = 0 ..... no errors encountered,
  ...
  int loadGridCoords(int i,               // input
                     int j,               // input
  ...
  void swapBytes(void* buffer,   // input & output
                 size_t size,    // input
                 size_t count);  // input
  ...
  int swGridIndices(double latitude,   // input
                    double longitude,  // input
                    int& i,            // output
                    int& j);           // output
