...
MercatorStandardParallelParameters::MercatorStandardParallelParameters(
    ...
    double __standardParallel, double __scaleFactor, double __falseEasting,
...
MercatorStandardParallelParameters &MercatorStandardParallelParameters::
operator=(const MercatorStandardParallelParameters &p) {
  if (this != &p) {
    _coordinateType = p._coordinateType;
...
void MercatorStandardParallelParameters::setCentralMeridian(
    double __centralMeridian) {
  _centralMeridian = __centralMeridian;
}

void MercatorStandardParallelParameters::setStandardParallel(
...
void MercatorStandardParallelParameters::setFalseEasting(
    double __falseEasting) {
  _falseEasting = __falseEasting;
}

void MercatorStandardParallelParameters::setFalseNorthing(
    double __falseNorthing) {
  _falseNorthing = __falseNorthing;
}
