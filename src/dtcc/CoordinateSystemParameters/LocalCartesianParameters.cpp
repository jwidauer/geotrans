...
LocalCartesianParameters::LocalCartesianParameters(
    CoordinateType::Enum _coordinateType, double __longitude, double __latitude,
...
LocalCartesianParameters &LocalCartesianParameters::operator=(
...
double LocalCartesianParameters::longitude() const { return _longitude; }

double LocalCartesianParameters::latitude() const { return _latitude; }

double LocalCartesianParameters::height() const { return _height; }

double LocalCartesianParameters::orientation() const { return _orientation; }
