...
ObliqueMercatorParameters::ObliqueMercatorParameters(
    CoordinateType::Enum _coordinateType, double __originLatitude,
    double __longitude1, double __latitude1, double __longitude2,
    double __latitude2, double __falseEasting, double __falseNorthing,
...
ObliqueMercatorParameters &ObliqueMercatorParameters::operator=(
...
double ObliqueMercatorParameters::longitude1() const { return _longitude1; }

double ObliqueMercatorParameters::latitude1() const { return _latitude1; }

double ObliqueMercatorParameters::longitude2() const { return _longitude2; }

double ObliqueMercatorParameters::latitude2() const { return _latitude2; }

double ObliqueMercatorParameters::falseEasting() const { return _falseEasting; }

double ObliqueMercatorParameters::falseNorthing() const {
  return _falseNorthing;
}

double ObliqueMercatorParameters::scaleFactor() const { return _scaleFactor; }
