...
MapProjection5Parameters::MapProjection5Parameters(
    ...
    double __originLatitude, double __scaleFactor, double __falseEasting,
...
MapProjection5Parameters &MapProjection5Parameters::operator=(
    const MapProjection5Parameters &p) {
  if (this != &p) {
    _coordinateType = p._coordinateType;
...
double MapProjection5Parameters::scaleFactor() const { return _scaleFactor; }

double MapProjection5Parameters::falseEasting() const { return _falseEasting; }
