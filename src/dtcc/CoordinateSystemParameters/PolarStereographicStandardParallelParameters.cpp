...
PolarStereographicStandardParallelParameters::
    PolarStereographicStandardParallelParameters(
        ...
        double __standardParallel, double __falseEasting,
...
void PolarStereographicStandardParallelParameters::setCentralMeridian(
    double __centralMeridian) {
  _centralMeridian = __centralMeridian;
}

void PolarStereographicStandardParallelParameters::setStandardParallel(
    double __standardParallel) {
  _standardParallel = __standardParallel;
}

void PolarStereographicStandardParallelParameters::setFalseEasting(
    double __falseEasting) {
  _falseEasting = __falseEasting;
}

void PolarStereographicStandardParallelParameters::setFalseNorthing(
    double __falseNorthing) {
  _falseNorthing = __falseNorthing;
}
