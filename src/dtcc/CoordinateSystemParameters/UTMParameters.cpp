...
UTMParameters::UTMParameters(CoordinateType::Enum _coordinateType)
    : CoordinateSystemParameters(_coordinateType), _zone(32), _override(0) {}
...
UTMParameters::UTMParameters(CoordinateType::Enum _coordinateType, long __zone,
                             long __override)
    : CoordinateSystemParameters(_coordinateType),
      _zone(__zone),
      _override(__override) {}
...
void UTMParameters::setZone(long __zone) { _zone = __zone; }

void UTMParameters::setOverride(long __override) { _override = __override; }

long UTMParameters::zone() const { return _zone; }

long UTMParameters::override() const { return _override; }
