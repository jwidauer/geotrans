...
MapProjection6Parameters::MapProjection6Parameters(
    ...
    double __standardParallel2, double __falseEasting, double __falseNorthing)
    : CoordinateSystemParameters(_coordinateType),
...
MapProjection6Parameters &MapProjection6Parameters::operator=(
    const MapProjection6Parameters &p) {
  if (this != &p) {
...
void MapProjection6Parameters::setStandardParallel1(
    double __standardParallel1) {
  _standardParallel1 = __standardParallel1;
}

void MapProjection6Parameters::setStandardParallel2(
...
double MapProjection6Parameters::falseEasting() const { return _falseEasting; }
