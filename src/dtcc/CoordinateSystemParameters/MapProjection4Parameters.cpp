...
MapProjection4Parameters::MapProjection4Parameters(
    ...
    double __originLatitude, double __falseEasting, double __falseNorthing)
    : CoordinateSystemParameters(_coordinateType),
...
MapProjection4Parameters::MapProjection4Parameters(
    const MapProjection4Parameters &p) {
...
MapProjection4Parameters &MapProjection4Parameters::operator=(
    const MapProjection4Parameters &p) {
  if (this != &p) {
    _coordinateType = p._coordinateType;
...
double MapProjection4Parameters::falseEasting() const { return _falseEasting; }
