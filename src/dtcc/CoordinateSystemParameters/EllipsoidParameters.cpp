...
EllipsoidParameters::EllipsoidParameters() : _semiMajorAxis(0), _flattening(0) {
  strncpy(_ellipsoidCode, "   ", 3);
}

EllipsoidParameters::EllipsoidParameters(double __semiMajorAxis,
                                         double __flattening,
                                         const char* __ellipsoidCode)
    : _semiMajorAxis(__semiMajorAxis), _flattening(__flattening) {
...
EllipsoidParameters& EllipsoidParameters::operator=(
    const EllipsoidParameters& ecp) {
  if (this != &ecp) {
    _semiMajorAxis = ecp._semiMajorAxis;
    _flattening = ecp._flattening;
    strncpy(_ellipsoidCode, ecp._ellipsoidCode, 3);
...
double EllipsoidParameters::semiMajorAxis() const { return _semiMajorAxis; }

double EllipsoidParameters::flattening() const { return _flattening; }

char* EllipsoidParameters::ellipsoidCode() { return _ellipsoidCode; }
