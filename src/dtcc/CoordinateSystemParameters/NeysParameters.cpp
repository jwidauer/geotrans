...
double NeysParameters::centralMeridian() const { return _centralMeridian; }

double NeysParameters::originLatitude() const { return _originLatitude; }

double NeysParameters::standardParallel1() const { return _standardParallel1; }

double NeysParameters::falseEasting() const { return _falseEasting; }

double NeysParameters::falseNorthing() const { return _falseNorthing; }
