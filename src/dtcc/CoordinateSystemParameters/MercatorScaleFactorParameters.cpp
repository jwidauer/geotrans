...
MercatorScaleFactorParameters::MercatorScaleFactorParameters(
    ...
    double __scaleFactor, double __falseEasting, double __falseNorthing)
    : CoordinateSystemParameters(_coordinateType),
...
MercatorScaleFactorParameters &MercatorScaleFactorParameters::operator=(
...
void MercatorScaleFactorParameters::setCentralMeridian(
