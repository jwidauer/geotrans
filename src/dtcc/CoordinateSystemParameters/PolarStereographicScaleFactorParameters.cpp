...
PolarStereographicScaleFactorParameters::
    PolarStereographicScaleFactorParameters(
        ...
        double __scaleFactor, char __hemisphere, double __falseEasting,
...
void PolarStereographicScaleFactorParameters::setCentralMeridian(
    double __centralMeridian) {
  _centralMeridian = __centralMeridian;
}

void PolarStereographicScaleFactorParameters::setScaleFactor(
...
void PolarStereographicScaleFactorParameters::setFalseEasting(
    double __falseEasting) {
  _falseEasting = __falseEasting;
}

void PolarStereographicScaleFactorParameters::setFalseNorthing(
    double __falseNorthing) {
  _falseNorthing = __falseNorthing;
}
