...
const char* ErrorMessages::datumFileOpenError =
...
const char* ErrorMessages::datumDomain =
    "Invalid local datum domain of validity\n";
const char* ErrorMessages::datumRotation =
    "Rotation values must be between -60.0 and 60.0";
const char* ErrorMessages::datumSigma =
...
const char* ErrorMessages::semiMajorAxis =
    "Ellipsoid semi-major axis must be greater than zero\n";
const char* ErrorMessages::ellipsoidFlattening =
    "Inverse flattening must be between 250 and 350\n";
const char* ErrorMessages::orientation = "Orientation out of range\n";
const char* ErrorMessages::originLatitude =
    "Origin Latitude (or Standard Parallel or Latitude of True Scale) out of "
    "range\n";
const char* ErrorMessages::originLongitude =
...
const char* ErrorMessages::standardParallel1 =
    "Invalid 1st Standard Parallel\n";
const char* ErrorMessages::standardParallel2 =
    "Invalid 2nd Standard Parallel\n";
const char* ErrorMessages::standardParallel1_2 =
    "1st & 2nd Standard Parallels cannot both be zero\n";
const char* ErrorMessages::standardParallelHemisphere =
...
const char* ErrorMessages::bngEllipsoid =
    "British National Grid ellipsoid must be Airy\n";
const char* ErrorMessages::nzmgEllipsoid =
    "New Zealand Map Grid ellipsoid must be International\n";
const char* ErrorMessages::webmEllipsoid =
    "Web Mercator ellipsoid must be WGS84\n";
const char* ErrorMessages::webmConversionTo =
    "GeoTrans does not allow conversion to Web Mercator\n";
const char* ErrorMessages::webmInvalidTargetCS =
...
const char* ErrorMessages::latitude1_2 =
...
const char* ErrorMessages::invalidIndex =
...
const char* ErrorMessages::longitude_min =
    "The longitude minute part of the string is greater than 60\n";
const char* ErrorMessages::latitude_min =
