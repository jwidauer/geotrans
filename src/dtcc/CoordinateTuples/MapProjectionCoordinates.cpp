...
MapProjectionCoordinates::MapProjectionCoordinates(
    ...
    : CoordinateTuple(_coordinateType), _easting(0), _northing(0) {}

MapProjectionCoordinates::MapProjectionCoordinates(
    CoordinateType::Enum _coordinateType, double __easting, double __northing)
...
double MapProjectionCoordinates::easting() const { return _easting; }

void MapProjectionCoordinates::setNorthing(double __northing) {
  _northing = __northing;
}

double MapProjectionCoordinates::northing() const { return _northing; }
