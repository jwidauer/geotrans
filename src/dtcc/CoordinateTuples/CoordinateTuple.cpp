...
CoordinateTuple::CoordinateTuple() : _coordinateType(CoordinateType::geodetic) {
...
void CoordinateTuple::setCoordinateType(
    MSP::CCS::CoordinateType::Enum __coordinateType) {
  _coordinateType = __coordinateType;
}
...
const char* CoordinateTuple::errorMessage() const { return _errorMessage; }
...
const char* CoordinateTuple::warningMessage() const { return _warningMessage; }
