...
Accuracy::Accuracy()
    : _circularError90(-1.0), _linearError90(-1.0), _sphericalError90(-1.0) {}

Accuracy::Accuracy(double __circularError90, double __linearError90,
...
void Accuracy::set(double __circularError90, double __linearError90,
                   double __sphericalError90) {
  _circularError90 = __circularError90;
  _linearError90 = __linearError90;
  _sphericalError90 = __sphericalError90;
...
double Accuracy::circularError90() { return _circularError90; }

double Accuracy::linearError90() { return _linearError90; }

double Accuracy::sphericalError90() { return _sphericalError90; }
