...
void UPSCoordinates::set(char __hemisphere, double __easting,
                         double __northing) {
  _hemisphere = __hemisphere;
  _easting = __easting;
  _northing = __northing;
...
char UPSCoordinates::hemisphere() const { return _hemisphere; }

double UPSCoordinates::easting() const { return _easting; }

double UPSCoordinates::northing() const { return _northing; }
