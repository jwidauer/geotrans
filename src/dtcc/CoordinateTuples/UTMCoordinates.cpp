...
UTMCoordinates::UTMCoordinates(CoordinateType::Enum _coordinateType,
                               long __zone, char __hemisphere, double __easting,
                               double __northing)
    : CoordinateTuple(_coordinateType),
      _zone(__zone),
...
UTMCoordinates::UTMCoordinates(CoordinateType::Enum _coordinateType,
                               const char* __warningMessage, long __zone,
                               char __hemisphere, double __easting,
                               double __northing)
    : CoordinateTuple(_coordinateType),
      _zone(__zone),
      _hemisphere(__hemisphere),
...
void UTMCoordinates::set(long __zone, char __hemisphere, double __easting,
                         double __northing) {
  _zone = __zone;
  _hemisphere = __hemisphere;
  _easting = __easting;
...
void UTMCoordinates::setZone(long __zone) { _zone = __zone; }

long UTMCoordinates::zone() const { return _zone; }

void UTMCoordinates::setHemisphere(char __hemisphere) {
  _hemisphere = __hemisphere;
}

char UTMCoordinates::hemisphere() const { return _hemisphere; }

void UTMCoordinates::setEasting(double __easting) { _easting = __easting; }

double UTMCoordinates::easting() const { return _easting; }

void UTMCoordinates::setNorthing(double __northing) { _northing = __northing; }

double UTMCoordinates::northing() const { return _northing; }
