...
CartesianCoordinates::CartesianCoordinates()
    : CoordinateTuple(CoordinateType::geocentric), _x(0), _y(0), _z(0) {}

CartesianCoordinates::CartesianCoordinates(CoordinateType::Enum _coordinateType)
    : CoordinateTuple(_coordinateType), _x(0), _y(0), _z(0) {}

CartesianCoordinates::CartesianCoordinates(CoordinateType::Enum _coordinateType,
                                           double __x, double __y, double __z)
    : CoordinateTuple(_coordinateType), _x(__x), _y(__y), _z(__z) {}
...
void CartesianCoordinates::setX(double __x) { _x = __x; }

void CartesianCoordinates::setY(double __y) { _y = __y; }

void CartesianCoordinates::setZ(double __z) { _z = __z; }

double CartesianCoordinates::x() const { return _x; }

double CartesianCoordinates::y() const { return _y; }

double CartesianCoordinates::z() const { return _z; }
