...
void GeodeticCoordinates::set(double __longitude, double __latitude,
                              double __height) {
  _longitude = __longitude;
  _latitude = __latitude;
  _height = __height;
...
void GeodeticCoordinates::setHeight(double __height) { _height = __height; }

double GeodeticCoordinates::longitude() const { return _longitude; }

double GeodeticCoordinates::latitude() const { return _latitude; }

double GeodeticCoordinates::height() const { return _height; }
