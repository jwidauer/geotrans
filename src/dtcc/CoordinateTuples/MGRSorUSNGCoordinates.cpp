...
MGRSorUSNGCoordinates::MGRSorUSNGCoordinates(
    ...
    : CoordinateTuple(_coordinateType), _precision(Precision::tenthOfSecond) {
  strncpy(_MGRSString, "31NEA0000000000", 20);
}

MGRSorUSNGCoordinates::MGRSorUSNGCoordinates(
    CoordinateType::Enum _coordinateType, const char* __MGRSString)
    : CoordinateTuple(_coordinateType), _precision(Precision::tenthOfSecond) {
...
MGRSorUSNGCoordinates::MGRSorUSNGCoordinates(
    ...
    : CoordinateTuple(_coordinateType), _precision(__precision) {
  strncpy(_MGRSString, __MGRSString, 20);
  _MGRSString[20] = '\0';
}

MGRSorUSNGCoordinates::MGRSorUSNGCoordinates(
    CoordinateType::Enum _coordinateType, const char* __warningMessage,
...
char* MGRSorUSNGCoordinates::MGRSString() { return _MGRSString; }
