...
class Mercator : public CoordinateSystem {
 public:
  ...
  Mercator(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
           double centralMeridian, double standardParallel, double falseEasting,
   ...
   * (output) the projection standardParallel        : Latitude in radians at
