...
class LocalCartesian : public CoordinateSystem {
 public:
   ...
   * (input) originLongitude          : Longitude of the local origin, in
   * radians         (input) originLatitude           : Latitude of the local
   * origin, in radians          (input) originHeight             : Ellipsoid
   * height of the local origin, in meters   (input) orientation              :
   * Orientation angle of the local cartesian coordinate system, in radians
   * (input)
   */

  LocalCartesian(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
  ...
  MSP::CCS::CartesianCoordinates* convertFromGeocentric(
  ...
  MSP::CCS::CartesianCoordinates* convertToGeocentric(
      const MSP::CCS::CartesianCoordinates* cartesianCoordinates);
 ...
 private:
  ...
  double Sin_Lat_Sin_Orient; /* sin(LocalCart_Origin_Lat) *
                                sin(LocalCart_Orientation) */
  double Sin_Lat_Cos_Orient; /* sin(LocalCart_Origin_Lat) *
                                cos(LocalCart_Orientation) */
  double Cos_Lat_Cos_Orient; /* cos(LocalCart_Origin_Lat) *
                                cos(LocalCart_Orientation) */
  double Cos_Lat_Sin_Orient; /* cos(LocalCart_Origin_Lat) *
                                sin(LocalCart_Orientation) */
};
}  // namespace CCS
}  // namespace MSP
