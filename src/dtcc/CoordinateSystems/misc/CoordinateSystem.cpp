...
CoordinateSystem::CoordinateSystem()
    : semiMajorAxis(6378137.0), flattening(1 / 298.257223563) {
  /*
...
CoordinateSystem::CoordinateSystem(double _semiMajorAxis, double _flattening)
    : semiMajorAxis(_semiMajorAxis), flattening(_flattening) {
  /*
...
/*long CoordinateSystem::setParameters( double _semiMajorAxis, double
_flattening )
{
