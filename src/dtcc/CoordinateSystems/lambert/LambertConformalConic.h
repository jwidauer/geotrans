...
class LambertConformalConic : public CoordinateSystem {
 public:
   ...
   * (input) centralMeridian            : Longitude of origin, in radians
   * (input) originLatitude             : Latitude of origin, in radians (input)
  ...
  LambertConformalConic(double ellipsoidSemiMajorAxis,
  ...
  LambertConformalConic(double ellipsoidSemiMajorAxis,
                        double ellipsoidFlattening, double centralMeridian,
                        double originLatitude, double standardParallel1,
   ...
   * (output) centralMeridian           : Longitude of origin, in radians
   * (output) originLatitude            : Latitude of origin, in radians
   * (output) falseEasting              : False easting, in meters (output)
   ...
   *   ellipsoidSemiMajorAxis  : Semi-major axis of ellipsoid, in meters
   * (output) ellipsoidFlattening     : Flattening of ellipsoid
   * (output) centralMeridian         : Longitude of origin, in radians (output)
 ...
 private:
  ...
  CommonParameters* setCommonLambert1StandardParallelParameters(
      double originLatitude, double falseNorthing, double scaleFactor);

  double calculateLambert2StandardParallel(double es2, double phi,
                                           double tempPhi, double c);
