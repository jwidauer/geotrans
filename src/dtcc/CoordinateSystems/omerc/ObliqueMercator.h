...
class ObliqueMercator : public CoordinateSystem {
 public:
   ...
   *                               ellipsoid (input) errorStatus              :
   * Error status                             (output)
   */

  ObliqueMercator(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
                  double originLatitude, double longitude1, double latitude1,
 ...
 private:
  ...
  double OMerc_False_Northing; /* False northing, in meters, at projection
                                  center */
  double
      OMerc_False_Easting; /* False easting, in meters, at projection center */
