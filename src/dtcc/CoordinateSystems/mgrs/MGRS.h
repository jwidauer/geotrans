...
class MSP_DTCC_API MGRS : public CoordinateSystem {
 public:
  ...
  MGRS(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
       char* ellipsoidCode);
 ...
 private:
  ...
  MSP::CCS::UTMCoordinates* toUTM(long zone, long letters[MGRS_LETTERS],
  ...
  MSP::CCS::UPSCoordinates* toUPS(long letters[MGRS_LETTERS], double easting,
                                  double northing);
