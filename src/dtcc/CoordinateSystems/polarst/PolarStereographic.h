...
class PolarStereographic : public CoordinateSystem {
 public:
   ...
   *
   *  ellipsoidSemiMajorAxis                : Semi-major axis of ellipsoid, in
   * meters         (input) ellipsoidFlattening                   : Flattening
   * of ellipsoid					                (input)
   *  centralMeridian                       : Longitude down from pole, in
   * radians            (input) standardParallel                      : Latitude
   * of true scale, in radians              (input) falseEasting : Easting (X)
   * at center of projection, in meters  (input) falseNorthing : Northing (Y) at
   * center of projection, in meters (input)
   */

  PolarStereographic(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
                     double centralMeridian, double standardParallel,
                     double falseEasting, double falseNorthing);

  /*
   * The constructor receives the ellipsoid
   * parameters and Polar Stereograpic (Scale Factor) projection parameters as
   ...
   * of ellipsoid					                (input)
   *  centralMeridian                       : Longitude down from pole, in
   * radians            (input) scaleFactor                           : Scale
   * Factor              (input) falseEasting                          : Easting
   * (X) at center of projection, in meters  (input) falseNorthing : Northing
   * (Y) at center of projection, in meters (input)
   */

  PolarStereographic(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
                     double centralMeridian, double scaleFactor,
