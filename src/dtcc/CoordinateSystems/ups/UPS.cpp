 ...
 *    PolarStereographic.h    - Is used to convert polar stereographic
 * coordinates MapProjectionCoordinates.h   - defines map projection coordinates
...
UPS::UPS(double ellipsoidSemiMajorAxis, double ellipsoidFlattening)
    : CoordinateSystem(), UPS_Origin_Latitude(MAX_ORIGIN_LAT) {
  /*
  ...
  polarStereographicMap['N'] =
      new PolarStereographic(semiMajorAxis, flattening, UPS_Origin_Longitude,
                             .994, 'N', UPS_False_Easting, UPS_False_Northing);
  polarStereographicMap['S'] =
      new PolarStereographic(semiMajorAxis, flattening, UPS_Origin_Longitude,
                             .994, 'S', UPS_False_Easting, UPS_False_Northing);
  /// polarStereographicMap['N'] = new PolarStereographic(semiMajorAxis,
  /// flattening, UPS_Origin_Longitude, UPS_Origin_Latitude, UPS_False_Easting,
  /// UPS_False_Northing); polarStereographicMap['S'] = new
  /// PolarStereographic(semiMajorAxis, flattening, UPS_Origin_Longitude,
...
MSP::CCS::UPSCoordinates* UPS::convertFromGeodetic(
  ...
  MapProjectionCoordinates* polarStereographicCoordinates =
      polarStereographic.convertFromGeodetic(geodeticCoordinates);
...
MSP::CCS::GeodeticCoordinates* UPS::convertToGeodetic(
