 ...
 *									                 (250 to
 *350) ALBERS_HEMISPHERE_ERROR   : Standard parallels cannot be opposite
 *                                     latitudes
...
class MSP_DTCC_API AlbersEqualAreaConic : public CoordinateSystem {
 public:
  ...
  AlbersEqualAreaConic(double ellipsoidSemiMajorAxis,
   ...
   * which the          (output) point scale factor is 1.0 standardParallel1 :
   * First standard parallel                   (output) standardParallel2 :
   * Second standard parallel                  (output) falseEasting : A
