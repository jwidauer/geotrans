...
Eckert4::Eckert4(double ellipsoidSemiMajorAxis, double ellipsoidFlattening,
...
MapProjection3Parameters* Eckert4::getParameters() const {
  ...
  return new MapProjection3Parameters(CoordinateType::eckert4, Eck4_Origin_Long,
                                      Eck4_False_Easting, Eck4_False_Northing);
}

MSP::CCS::MapProjectionCoordinates* Eckert4::convertFromGeodetic(
  ...
  return new MapProjectionCoordinates(CoordinateType::eckert4, easting,
                                      northing);
}

MSP::CCS::GeodeticCoordinates* Eckert4::convertToGeodetic(
  ...
  if ((easting < (Eck4_False_Easting + Eck4_Min_Easting)) ||
      (easting >
       (Eck4_False_Easting + Eck4_Max_Easting))) { /* Easting out of range  */
    throw CoordinateConversionException(ErrorMessages::easting);
  }
  if ((northing < (Eck4_False_Northing - Eck4_Delta_Northing)) ||
      (northing > (Eck4_False_Northing +
                   Eck4_Delta_Northing))) { /* Northing out of range */
