 ...
 *    01/16/16  A. Layne MSP_DR30125 added pass of ellipsoid code into
 * transverseMercator and UTM.
 */
...
CoordinateConversionService::CCSData::CCSData() : refCount(1) {
  ellipsoidLibraryImplementation =
      EllipsoidLibraryImplementation::getInstance();
...
CoordinateConversionService::CoordinateConversionService(
  ...
  Coordinate_System_Table[4].coordinateSystem = CoordinateType::cassini;
  ...
  Coordinate_System_Table[6].coordinateSystem = CoordinateType::eckert4;

  strcpy(Coordinate_System_Table[7].Name, "Eckert VI (S)");
  strcpy(Coordinate_System_Table[7].Code, "ED");
  Coordinate_System_Table[7].coordinateSystem = CoordinateType::eckert6;
  ...
  Coordinate_System_Table[9].coordinateSystem = CoordinateType::geocentric;
  ...
  strcpy(Coordinate_System_Table[19].Name,
  ...
  strcpy(Coordinate_System_Table[27].Name,
  ...
  Coordinate_System_Table[35].coordinateSystem = CoordinateType::usNationalGrid;
...
CoordinateConversionService& CoordinateConversionService::operator=(
  ...
  if (ccsData == ccs.ccsData) return *this;

  if (--ccsData->refCount == 0) delete ccsData;
...
void CoordinateConversionService::convertSourceToTarget(
    CoordinateTuple* sourceCoordinates, Accuracy* sourceAccuracy,
    CoordinateTuple& targetCoordinates, Accuracy& targetAccuracy) {
  /*
   ...
   *  system defined by the target coordinate system parameters and target
   * datum.
   */

  convert(SourceOrTarget::source, SourceOrTarget::target, sourceCoordinates,
          sourceAccuracy, targetCoordinates, targetAccuracy);
}
...
void CoordinateConversionService::convertTargetToSource(
    ...
    CoordinateTuple& sourceCoordinates, Accuracy& sourceAccuracy) {
  /*
   *  The function convertTargetToSource converts the current target coordinates
   * in the coordinate system defined by the current target coordinate system
   * parameters and target datum, into source coordinates in the coordinate
   * system defined by the source coordinate system parameters and source datum.
   */

  convert(SourceOrTarget::target, SourceOrTarget::source, targetCoordinates,
          targetAccuracy, sourceCoordinates, sourceAccuracy);
}
...
void CoordinateConversionService::convertSourceToTargetCollection(
  ...
  convertCollection(sourceCoordinates, sourceAccuracy, targetCoordinates,
                    targetAccuracy);
}
...
void CoordinateConversionService::convertTargetToSourceCollection(
  ...
  convertCollection(targetCoordinates, targetAccuracy, sourceCoordinates,
                    sourceAccuracy);
}
...
CoordinateConversionService::getCoordinateSystem(
  ...
  switch (coordinateSystemState[direction].coordinateType) {
    ...
    case CoordinateType::lambertConformalConic2Parallels:
      return coordinateSystemState[direction]
          .parameters.mapProjection6Parameters;
    ...
    case CoordinateType::stereographic:
      return coordinateSystemState[direction]
          .parameters.mapProjection4Parameters;
    ...
    case CoordinateType::vanDerGrinten:
      return coordinateSystemState[direction]
          .parameters.mapProjection3Parameters;
    case CoordinateType::equidistantCylindrical:
      return coordinateSystemState[direction]
          .parameters.equidistantCylindricalParameters;
    ...
    case CoordinateType::transverseCylindricalEqualArea:
      return coordinateSystemState[direction]
          .parameters.mapProjection5Parameters;
    case CoordinateType::localCartesian:
      return coordinateSystemState[direction]
          .parameters.localCartesianParameters;
    case CoordinateType::mercatorStandardParallel:
      return ((Mercator*)(coordinateSystemState[direction].coordinateSystem))
          ->getStandardParallelParameters();  // gets the calculated scale
                                              // factor
    case CoordinateType::mercatorScaleFactor:
      return coordinateSystemState[direction]
          .parameters.mercatorScaleFactorParameters;
    ...
    case CoordinateType::obliqueMercator:
      return coordinateSystemState[direction]
          .parameters.obliqueMercatorParameters;
    case CoordinateType::polarStereographicStandardParallel:
      return coordinateSystemState[direction]
          .parameters.polarStereographicStandardParallelParameters;
    case CoordinateType::polarStereographicScaleFactor:
      return coordinateSystemState[direction]
          .parameters.polarStereographicScaleFactorParameters;
    ...
    case CoordinateType::webMercator:
      return coordinateSystemState[direction]
          .parameters.coordinateSystemParameters;
    default:
...
void CoordinateConversionService::initCoordinateSystemState(
  ...
  coordinateSystemState[direction]
      .parameters.mercatorStandardParallelParameters = 0;
  ...
  coordinateSystemState[direction]
      .parameters.polarStereographicStandardParallelParameters = 0;
  coordinateSystemState[direction]
      .parameters.polarStereographicScaleFactorParameters = 0;
...
void CoordinateConversionService::setDatum(const SourceOrTarget::Enum direction,
  ...
  switch (parameters->coordinateType()) {
    ...
    case CoordinateType::mercatorStandardParallel:
      coordinateSystemState[direction].coordinateType =
          CoordinateType::mercatorStandardParallel;
      coordinateSystemState[direction]
          .parameters.mercatorStandardParallelParameters =
    ...
    case CoordinateType::polarStereographicScaleFactor:
      ...
      coordinateSystemState[direction]
          ...
          new PolarStereographicScaleFactorParameters(
              *dynamic_cast<PolarStereographicScaleFactorParameters*>(
                  parameters));
      break;
    case CoordinateType::polyconic:
      coordinateSystemState[direction].coordinateType =
...
void CoordinateConversionService::setParameters(
  ...
  datumLibraryImplementation->datumEllipsoidCode(row->datumIndex,
                                                 ellipsoidCode);

  ellipsoidLibraryImplementation->ellipsoidIndex(ellipsoidCode,
                                                 &ellipsoidIndex);
  ...
  switch (coordinateSystemState[direction].coordinateType) {
    case CoordinateType::albersEqualAreaConic: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new AlbersEqualAreaConic(
              semiMajorAxis, flattening, param->centralMeridian(),
              param->originLatitude(), param->standardParallel1(),
              param->standardParallel2(), param->falseEasting(),
              param->falseNorthing());
      break;
    }
    case CoordinateType::azimuthalEquidistant: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new AzimuthalEquidistant(
              semiMajorAxis, flattening, param->centralMeridian(),
              param->originLatitude(), param->falseEasting(),
              param->falseNorthing());
      break;
    }
    case CoordinateType::bonne: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Bonne(semiMajorAxis, flattening, param->centralMeridian(),
                    param->originLatitude(), param->falseEasting(),
                    param->falseNorthing());
      break;
    }
    ...
    case CoordinateType::cassini: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Cassini(semiMajorAxis, flattening, param->centralMeridian(),
                      param->originLatitude(), param->falseEasting(),
                      param->falseNorthing());
      break;
    }
    ...
    case CoordinateType::eckert4: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Eckert4(semiMajorAxis, flattening, param->centralMeridian(),
                      param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::eckert6: {
      MapProjection3Parameters* param =
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Eckert6(semiMajorAxis, flattening, param->centralMeridian(),
                      param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::equidistantCylindrical: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new EquidistantCylindrical(
              semiMajorAxis, flattening, param->centralMeridian(),
              param->standardParallel(), param->falseEasting(),
              param->falseNorthing());
      break;
    }
    case CoordinateType::geocentric: {
    ...
    case CoordinateType::gnomonic: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Gnomonic(semiMajorAxis, flattening, param->centralMeridian(),
                       param->originLatitude(), param->falseEasting(),
                       param->falseNorthing());
      break;
    }
    case CoordinateType::lambertConformalConic1Parallel: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new LambertConformalConic(
              semiMajorAxis, flattening, param->centralMeridian(),
              param->originLatitude(), param->falseEasting(),
              param->falseNorthing(), param->scaleFactor());
      break;
    }
    case CoordinateType::lambertConformalConic2Parallels: {
      MapProjection6Parameters* param =
    ...
    case CoordinateType::localCartesian: {
      ...
      coordinateSystemState[direction].coordinateSystem = new LocalCartesian(
          semiMajorAxis, flattening, param->longitude(), param->latitude(),
          param->height(), param->orientation());
      break;
    }
    case CoordinateType::mercatorStandardParallel: {
      ...
      double scaleFactor;
      coordinateSystemState[direction].coordinateSystem =
          new Mercator(semiMajorAxis, flattening, param->centralMeridian(),
                       param->standardParallel(), param->falseEasting(),
                       param->falseNorthing(), &scaleFactor);
    ...
    case CoordinateType::mercatorScaleFactor: {
      ...
      coordinateSystemState[direction].coordinateSystem = new Mercator(
          semiMajorAxis, flattening, param->centralMeridian(),
          param->falseEasting(), param->falseNorthing(), param->scaleFactor());

      break;
    }
    case CoordinateType::militaryGridReferenceSystem: {
      coordinateSystemState[direction].coordinateSystem =
          new MGRS(semiMajorAxis, flattening, ellipsoidCode);
    ...
    case CoordinateType::mollweide: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Mollweide(semiMajorAxis, flattening, param->centralMeridian(),
                        param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::newZealandMapGrid: {
    ...
    case CoordinateType::neys: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Neys(semiMajorAxis, flattening, param->centralMeridian(),
                   param->originLatitude(), param->standardParallel1(),
                   param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::obliqueMercator: {
      ...
      coordinateSystemState[direction].coordinateSystem = new ObliqueMercator(
          semiMajorAxis, flattening, param->originLatitude(),
          param->longitude1(), param->latitude1(), param->longitude2(),
          param->latitude2(), param->falseEasting(), param->falseNorthing(),
          param->scaleFactor());
      break;
    }
    case CoordinateType::orthographic: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Orthographic(semiMajorAxis, flattening, param->centralMeridian(),
                           param->originLatitude(), param->falseEasting(),
                           param->falseNorthing());
      break;
    }
    case CoordinateType::polarStereographicStandardParallel: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new PolarStereographic(semiMajorAxis, flattening,
    ...
    case CoordinateType::polarStereographicScaleFactor: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new PolarStereographic(semiMajorAxis, flattening,
                                 param->centralMeridian(), param->scaleFactor(),
                                 param->hemisphere(), param->falseEasting(),
                                 param->falseNorthing());
      break;
    }
    case CoordinateType::polyconic: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Polyconic(semiMajorAxis, flattening, param->centralMeridian(),
                        param->originLatitude(), param->falseEasting(),
                        param->falseNorthing());
      break;
    }
    case CoordinateType::sinusoidal: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Sinusoidal(semiMajorAxis, flattening, param->centralMeridian(),
                         param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::stereographic: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new Stereographic(semiMajorAxis, flattening, param->centralMeridian(),
                            param->originLatitude(), param->falseEasting(),
                            param->falseNorthing());
      break;
    }
    ...
    case CoordinateType::transverseMercator: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new TransverseMercator(
              semiMajorAxis, flattening, param->centralMeridian(),
              param->originLatitude(), param->falseEasting(),
              param->falseNorthing(), param->scaleFactor(), ellipsoidCode);
      break;
    }
    case CoordinateType::universalPolarStereographic: {
      coordinateSystemState[direction].coordinateSystem =
          new UPS(semiMajorAxis, flattening);
    ...
    case CoordinateType::universalTransverseMercator: {
      if (direction == SourceOrTarget::target) {
        ...
        if ((param->override() != 0) && (param->zone() == 0))
          ...
          if (param->override() == 0) param->setZone(0);
        }

        coordinateSystemState[direction].coordinateSystem =
            new UTM(semiMajorAxis, flattening, ellipsoidCode, param->zone());
      } else
        coordinateSystemState[direction].coordinateSystem =
            new UTM(semiMajorAxis, flattening, ellipsoidCode, 0);

      break;
    }
    case CoordinateType::usNationalGrid: {
      coordinateSystemState[direction].coordinateSystem =
          new USNG(semiMajorAxis, flattening, ellipsoidCode);
    ...
    case CoordinateType::vanDerGrinten: {
      ...
      coordinateSystemState[direction].coordinateSystem =
          new VanDerGrinten(semiMajorAxis, flattening, param->centralMeridian(),
                            param->falseEasting(), param->falseNorthing());
      break;
    }
    case CoordinateType::webMercator: {
...
void CoordinateConversionService::deleteCoordinateSystem(
  ...
  switch (coordinateSystemState[direction].coordinateType) {
    case CoordinateType::albersEqualAreaConic:
      if (coordinateSystemState[direction]
              .parameters.mapProjection6Parameters) {
        delete coordinateSystemState[direction]
            .parameters.mapProjection6Parameters;
        coordinateSystemState[direction].parameters.mapProjection6Parameters =
            0;
      }
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((AlbersEqualAreaConic*)(coordinateSystemState[direction]
                                            .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    case CoordinateType::lambertConformalConic2Parallels:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((LambertConformalConic*)(coordinateSystemState[direction]
                                             .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    case CoordinateType::azimuthalEquidistant:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((AzimuthalEquidistant*)(coordinateSystemState[direction]
                                            .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::cylindricalEqualArea:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((CylindricalEqualArea*)(coordinateSystemState[direction]
                                            .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::britishNationalGrid:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((BritishNationalGrid*)(coordinateSystemState[direction]
                                           .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::millerCylindrical:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((MillerCylindrical*)(coordinateSystemState[direction]
                                         .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::equidistantCylindrical:
      if (coordinateSystemState[direction]
        ...
        delete coordinateSystemState[direction]
            .parameters.equidistantCylindricalParameters;
        coordinateSystemState[direction]
            .parameters.equidistantCylindricalParameters = 0;
      }
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((EquidistantCylindrical*)(coordinateSystemState[direction]
                                              .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::transverseCylindricalEqualArea:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete (
            (TransverseCylindricalEqualArea*)(coordinateSystemState[direction]
                                                  .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    case CoordinateType::transverseMercator:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((TransverseMercator*)(coordinateSystemState[direction]
                                          .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    case CoordinateType::localCartesian:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((LocalCartesian*)(coordinateSystemState[direction]
                                      .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    ...
    case CoordinateType::mercatorScaleFactor:
      if (coordinateSystemState[direction]
        ...
        delete coordinateSystemState[direction]
            .parameters.mercatorScaleFactorParameters;
        coordinateSystemState[direction]
            .parameters.mercatorScaleFactorParameters = 0;
      }
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((Mercator*)(coordinateSystemState[direction].coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
    ...
    case CoordinateType::obliqueMercator:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((ObliqueMercator*)(coordinateSystemState[direction]
                                       .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
    case CoordinateType::polarStereographicStandardParallel:
      ...
      if (coordinateSystemState[direction].coordinateSystem) {
        delete ((PolarStereographic*)(coordinateSystemState[direction]
                                          .coordinateSystem));
        coordinateSystemState[direction].coordinateSystem = 0;
      }
      break;
...
void CoordinateConversionService::copyParameters(
    SourceOrTarget::Enum direction, CoordinateType::Enum coordinateType,
    Parameters parameters) {
  /*
   *  The function copyParameters uses the input parameters to set the value of
   * the current parameters.
   *
   *  direction       : Indicates whether the coordinate system is to be used
   * for source or target                                      (input)
   *  coordinateType  : Coordinate system type (input) parameters      :
   * Coordinate system parameters to copy                (input)
   */
  ...
  switch (coordinateType) {
    ...
    case CoordinateType::polarStereographicStandardParallel:
      setCoordinateSystem(
          direction, parameters.polarStereographicStandardParallelParameters);
      break;
    case CoordinateType::polarStereographicScaleFactor:
      setCoordinateSystem(direction,
                          parameters.polarStereographicScaleFactorParameters);
...
void CoordinateConversionService::convert(SourceOrTarget::Enum sourceDirection,
  ...
  /*
   *  The function convert converts the current source coordinates in the
   * coordinate system defined by the current source coordinate system
   * parameters and source datum, into target coordinates in the coordinate
   * system defined by the target coordinate system parameters and target datum.
   *
   *  sourceDirection: Indicates which set of coordinates and parameters to use
   * as the source (input) targetDirection: Indicates which set of coordinates
   * and parameters to use as the target (input)
   */
  ...
  try {
      ...
      if (source->datumIndex == target->datumIndex) {
        if ((source->coordinateType == CoordinateType::geocentric) &&
          ...
          CartesianCoordinates* cartesianCoordinates =
              ((LocalCartesian*)(target->coordinateSystem))
                  ->convertFromGeocentric(coordinates);
          ...
          CartesianCoordinates* cartesianCoordinates =
              ((LocalCartesian*)(source->coordinateSystem))
                  ->convertToGeocentric(coordinates);
          (dynamic_cast<CartesianCoordinates&>(targetCoordinates)) =
              *dynamic_cast<CartesianCoordinates*>(cartesianCoordinates);
          delete cartesianCoordinates;
        } else if ((source->coordinateType ==
                    CoordinateType::militaryGridReferenceSystem) &&
        ...
        (dynamic_cast<UPSCoordinates&>(targetCoordinates)) =
            *dynamic_cast<UPSCoordinates*>(upsCoordinates);
        ...
        Precision::Enum temp_precision =
            (dynamic_cast<MGRSorUSNGCoordinates&>(targetCoordinates))
                .precision();  /// ccsPrecision;
        if (temp_precision < 0) temp_precision = Precision::degree;
        if (temp_precision > 5) temp_precision = Precision::tenthOfSecond;

        UTMCoordinates* coordinates =
            dynamic_cast<UTMCoordinates*>(sourceCoordinates);

        MGRSorUSNGCoordinates* mgrsOrUSNGCoordinates =
            ((MGRS*)(target->coordinateSystem))
                ->convertFromUTM(coordinates, temp_precision);
        (dynamic_cast<MGRSorUSNGCoordinates&>(targetCoordinates)) =
        ...
        UPSCoordinates* coordinates =
            dynamic_cast<UPSCoordinates*>(sourceCoordinates);

        MGRSorUSNGCoordinates* mgrsOrUSNGCoordinates =
            ((MGRS*)(target->coordinateSystem))
                ->convertFromUPS(coordinates, temp_precision);
        (dynamic_cast<MGRSorUSNGCoordinates&>(targetCoordinates)) =
            *dynamic_cast<MGRSorUSNGCoordinates*>(mgrsOrUSNGCoordinates);
        delete mgrsOrUSNGCoordinates;
        ...
        if ((param->centralMeridian() == -2.0 * PI / 180) &&
          ...
          MapProjectionCoordinates* mapProjectionCoordinates =
              ((BritishNationalGrid*)(source->coordinateSystem))
                  ->convertToTransverseMercator(coordinates);
    ...
    if (!special) {
      ...
      else if ((source->coordinateType == CoordinateType::geocentric) ||
               (source->coordinateType == CoordinateType::localCartesian))
      ...
      if (target->coordinateType == CoordinateType::geodetic)
        output_height_type =
            target->parameters.geodeticParameters->heightType();
      else if ((target->coordinateType == CoordinateType::geocentric) ||
               (target->coordinateType == CoordinateType::localCartesian))
      ...
      if ((source->datumIndex == target->datumIndex) &&
          ((input_height_type == output_height_type) ||
           (input_height_type == HeightType::noHeight) ||
           (output_height_type ==
            HeightType::noHeight))) { /* Copy coordinate tuple */
      ...
      } else { /* Shift to WGS84, apply geoid correction, shift to target datum
                */
        if (source->datumIndex != WGS84_datum_index) {
        ...
        if (target->datumIndex != WGS84_datum_index) {
          _shiftedGeodetic = datumLibraryImplementation->geodeticShiftFromWGS84(
      ...
      if (strlen(sourceWarningMessage) > 0 || strlen(targetWarningMessage) > 0)
        ...
        Accuracy* _targetAccuracy = datumLibraryImplementation->datumShiftError(
            source->datumIndex, target->datumIndex, _wgs84Geodetic->longitude(),
            _wgs84Geodetic->latitude(), sourceAccuracy, prec);

        targetAccuracy.set(_targetAccuracy->circularError90(),
      ...
      convertGeodeticToTarget(targetDirection, _shiftedGeodetic,
...
GeodeticCoordinates* CoordinateConversionService::convertSourceToGeodetic(
    SourceOrTarget::Enum sourceDirection, CoordinateTuple* sourceCoordinates,
  ...
  try {
    switch (source->coordinateType) {
      case CoordinateType::geocentric: {
        ...
        return ((Geocentric*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::geodetic: {
        GeodeticCoordinates* _convertedGeodetic = new GeodeticCoordinates(
            *dynamic_cast<GeodeticCoordinates*>(sourceCoordinates));

        if (source->parameters.geodeticParameters->heightType() ==
            HeightType::noHeight)
      ...
      case CoordinateType::georef: {
        GEOREFCoordinates* coordinates =
            dynamic_cast<GEOREFCoordinates*>(sourceCoordinates);

        return ((GEOREF*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::albersEqualAreaConic: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((AlbersEqualAreaConic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::azimuthalEquidistant: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((AzimuthalEquidistant*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::britishNationalGrid: {
        BNGCoordinates* coordinates =
        ...
        return ((BritishNationalGrid*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::bonne: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Bonne*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::cassini: {
        MapProjectionCoordinates* coordinates =
        ...
        GeodeticCoordinates* _convertedGeodetic =
            ((Cassini*)(source->coordinateSystem))
                ->convertToGeodetic(coordinates);
      ...
      case CoordinateType::cylindricalEqualArea: {
        ...
        return ((CylindricalEqualArea*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::eckert4: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Eckert4*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::eckert6: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Eckert6*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::equidistantCylindrical: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((EquidistantCylindrical*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::globalAreaReferenceSystem: {
        GARSCoordinates* coordinates =
            dynamic_cast<GARSCoordinates*>(sourceCoordinates);

        return ((GARS*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::gnomonic: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Gnomonic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::lambertConformalConic1Parallel: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((LambertConformalConic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::lambertConformalConic2Parallels: {
        MapProjectionCoordinates* coordinates =
      ...
      case CoordinateType::localCartesian: {
        ...
        return ((LocalCartesian*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::mercatorStandardParallel:
      case CoordinateType::mercatorScaleFactor: {
        ...
        return ((Mercator*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::militaryGridReferenceSystem: {
        MGRSorUSNGCoordinates* coordinates =
      ...
      case CoordinateType::millerCylindrical: {
        ...
        return ((MillerCylindrical*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::mollweide: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Mollweide*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::neys: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Neys*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::newZealandMapGrid: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((NZMG*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::obliqueMercator: {
        MapProjectionCoordinates* coordinates =
        ...
        GeodeticCoordinates* _convertedGeodetic =
            ((ObliqueMercator*)(source->coordinateSystem))
                ->convertToGeodetic(coordinates);
      ...
      case CoordinateType::orthographic: {
        ...
        return ((Orthographic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::polarStereographicStandardParallel:
      case CoordinateType::polarStereographicScaleFactor: {
        ...
        return ((PolarStereographic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::polyconic: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Polyconic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::sinusoidal: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Sinusoidal*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::stereographic: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((Stereographic*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::transverseCylindricalEqualArea: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((TransverseCylindricalEqualArea*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::transverseMercator: {
        MapProjectionCoordinates* coordinates =
        ...
        GeodeticCoordinates* _convertedGeodetic =
            ((TransverseMercator*)(source->coordinateSystem))
                ->convertToGeodetic(coordinates);
      ...
      case CoordinateType::universalPolarStereographic: {
        ...
        return ((UPS*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::usNationalGrid: {
        MGRSorUSNGCoordinates* coordinates =
      ...
      case CoordinateType::universalTransverseMercator: {
        ...
        return ((UTM*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::vanDerGrinten: {
        MapProjectionCoordinates* coordinates =
        ...
        return ((VanDerGrinten*)(source->coordinateSystem))
            ->convertToGeodetic(coordinates);
      }
      case CoordinateType::webMercator: {
        MapProjectionCoordinates* coordinates =
...
void CoordinateConversionService::convertGeodeticToTarget(
    SourceOrTarget::Enum targetDirection, GeodeticCoordinates* _shiftedGeodetic,
    CoordinateTuple& targetCoordinates, char* targetWarningMessage) {
  Coordinate_State_Row* target = &coordinateSystemState[targetDirection];
  ...
  try {
    switch (target->coordinateType) {
      case CoordinateType::geocentric: {
        CartesianCoordinates* coordinates =
            ((Geocentric*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::geodetic: {
        if (target->parameters.geodeticParameters->heightType() ==
            HeightType::noHeight)
          (dynamic_cast<GeodeticCoordinates&>(targetCoordinates))
              .set(_shiftedGeodetic->longitude(), _shiftedGeodetic->latitude(),
                   0.0);
        else
          (dynamic_cast<GeodeticCoordinates&>(targetCoordinates))
              .set(_shiftedGeodetic->longitude(), _shiftedGeodetic->latitude(),
      ...
      case CoordinateType::georef: {
        Precision::Enum temp_precision =
            (dynamic_cast<GEOREFCoordinates&>(targetCoordinates)).precision();
        if (temp_precision < 0) temp_precision = Precision::degree;
        if (temp_precision > 5) temp_precision = Precision::tenthOfSecond;

        GEOREFCoordinates* coordinates =
            ((GEOREF*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic, temp_precision);

        (dynamic_cast<GEOREFCoordinates&>(targetCoordinates))
            .set(coordinates->GEOREFString());
      ...
      case CoordinateType::albersEqualAreaConic: {
        MapProjectionCoordinates* coordinates =
            ((AlbersEqualAreaConic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);

        (dynamic_cast<MapProjectionCoordinates&>(targetCoordinates))
            .set(coordinates->easting(), coordinates->northing());
      ...
      case CoordinateType::azimuthalEquidistant: {
        MapProjectionCoordinates* coordinates =
            ((AzimuthalEquidistant*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::cassini: {
        MapProjectionCoordinates* coordinates =
            ((Cassini*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::cylindricalEqualArea: {
        MapProjectionCoordinates* coordinates =
            ((CylindricalEqualArea*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::eckert4: {
        MapProjectionCoordinates* coordinates =
            ((Eckert4*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::eckert6: {
        MapProjectionCoordinates* coordinates =
            ((Eckert6*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::equidistantCylindrical: {
        MapProjectionCoordinates* coordinates =
            ((EquidistantCylindrical*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::globalAreaReferenceSystem: {
        ...
        GARSCoordinates* coordinates =
            ((GARS*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic, temp_precision);

        (dynamic_cast<GARSCoordinates&>(targetCoordinates))
            .set(coordinates->GARSString());
      ...
      case CoordinateType::gnomonic: {
        MapProjectionCoordinates* coordinates =
            ((Gnomonic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::lambertConformalConic1Parallel: {
        MapProjectionCoordinates* coordinates =
            ((LambertConformalConic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::mercatorScaleFactor: {
        MapProjectionCoordinates* coordinates =
            ((Mercator*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::millerCylindrical: {
        MapProjectionCoordinates* coordinates =
            ((MillerCylindrical*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::mollweide: {
        MapProjectionCoordinates* coordinates =
            ((Mollweide*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::obliqueMercator: {
        MapProjectionCoordinates* coordinates =
            ((ObliqueMercator*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::orthographic: {
        MapProjectionCoordinates* coordinates =
            ((Orthographic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::polarStereographicScaleFactor: {
        MapProjectionCoordinates* coordinates =
            ((PolarStereographic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::polyconic: {
        MapProjectionCoordinates* coordinates =
            ((Polyconic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::sinusoidal: {
        MapProjectionCoordinates* coordinates =
            ((Sinusoidal*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::stereographic: {
        MapProjectionCoordinates* coordinates =
            ((Stereographic*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::transverseCylindricalEqualArea: {
        MapProjectionCoordinates* coordinates =
            ((TransverseCylindricalEqualArea*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::transverseMercator: {
        MapProjectionCoordinates* coordinates =
            ((TransverseMercator*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::universalPolarStereographic: {
        UPSCoordinates* coordinates =
            ((UPS*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);

        (dynamic_cast<UPSCoordinates&>(targetCoordinates))
            .set(coordinates->hemisphere(), coordinates->easting(),
      ...
      case CoordinateType::universalTransverseMercator: {
        UTMCoordinates* coordinates =
            ((UTM*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);

        (dynamic_cast<UTMCoordinates&>(targetCoordinates))
            .set(coordinates->zone(), coordinates->hemisphere(),
      ...
      case CoordinateType::vanDerGrinten: {
        MapProjectionCoordinates* coordinates =
            ((VanDerGrinten*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
      ...
      case CoordinateType::webMercator: {
        MapProjectionCoordinates* coordinates =
            ((WebMercator*)(target->coordinateSystem))
                ->convertFromGeodetic(_shiftedGeodetic);
...
void CoordinateConversionService::convertCollection(
   ...
   *  sourceAccuracyCollection  : Source circular/linear/spherical errors
   * (input) targetCoordinatesCollection : Converted coordinates (output)
   *  targetAccuracyCollection  : Target circular/linear/spherical errors
   * (output)
   */
  ...
  for (int i = 0; i < num; i++) {
    ...
    if (_sourceCoordinates && _sourceAccuracy) {
      switch (targetCoordinateType) {
        ...
        case CoordinateType::bonne: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::bonne);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::britishNationalGrid: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new BNGCoordinates(CoordinateType::britishNationalGrid);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::cassini: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::cassini);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::eckert4: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::eckert4);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::eckert6: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::eckert6);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::geocentric: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new CartesianCoordinates(CoordinateType::geocentric);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::geodetic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new GeodeticCoordinates(CoordinateType::geodetic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::globalAreaReferenceSystem: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new GARSCoordinates(CoordinateType::globalAreaReferenceSystem);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::gnomonic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::gnomonic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::localCartesian: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new CartesianCoordinates(CoordinateType::localCartesian);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::millerCylindrical: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::millerCylindrical);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::mollweide: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::mollweide);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::newZealandMapGrid: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::newZealandMapGrid);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::neys: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::neys);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::obliqueMercator: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::obliqueMercator);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::orthographic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::orthographic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::polyconic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::polyconic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::sinusoidal: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::sinusoidal);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::stereographic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::stereographic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::universalPolarStereographic: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new UPSCoordinates(CoordinateType::universalPolarStereographic);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
                    _sourceCoordinates, _sourceAccuracy, *_targetCoordinates,
                    *_targetAccuracy);
          } catch (CoordinateConversionException e) {
            _targetCoordinates->setErrorMessage(e.getMessage());
          }
        ...
        case CoordinateType::universalTransverseMercator: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new UTMCoordinates(CoordinateType::universalTransverseMercator);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::usNationalGrid: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MGRSorUSNGCoordinates(CoordinateType::usNationalGrid);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
        ...
        case CoordinateType::vanDerGrinten: {
          if (i < numTargetCoordinates)
            ...
            _targetCoordinates =
                new MapProjectionCoordinates(CoordinateType::vanDerGrinten);
            targetCoordinateExists = false;
          }
          try {
            convert(SourceOrTarget::source, SourceOrTarget::target,
      ...
      if (i >= numTargetCoordinates) targetCoordinateExists = false;
      ...
      if (_sourceCoordinates) {
        if (!targetCoordinateExists)
          ...
          _targetCoordinates = targetCoordinatesCollection[i];
          _targetCoordinates->set(_sourceCoordinates->coordinateType(),
